...
var Pagination = function (_Component) {
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      if (!props.diableInputPaginate) {
        inputDom = _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: 'page-input-btn', onTouchTap: this._onInputOk.bind(this) },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'li',
          { onTouchTap: this._handlePrev.bind(this), className: prevCls },
          _react2.default.createElement(
            'span',
        ...
        _react2.default.createElement(
          'li',
          { onTouchTap: this._handleNext.bind(this), className: nextCls },
          _react2.default.createElement(
            'span',
            { className: 'page-link-btn', href: '' },
    ...
    value: function _onInputOk(e) {
      e.preventDefault();
      var value = parseInt(this.state.inputValue) - 1;
