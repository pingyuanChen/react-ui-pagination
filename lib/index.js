...
var _PageItem = require('./PageItem.jsx');
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'li',
          { onClick: this._handleNext, className: nextCls },
          _react2.default.createElement(
            'a',
            { className: 'page-link-btn', href: '' },
        ...
        !props.diableInputPaginate && _react2.default.createElement(
          'li',
          { className: 'page-input-wrap' },
          _react2.default.createElement('input', { ref: 'pageInput', className: 'page-input', value: this.state.selected + 1 }),
          _react2.default.createElement(
            'button',
      ...
      if (props.pageNum <= props.middleDisplayRange) {
        ...
        for (var i = 0; i < pageNum; i++) {
          ...
          if (lastBreakLabel !== breakView) {
            breakView = _react2.default.createElement(
              'li',
              { className: 'g-break' },
              props.breakLabel
            );
